    ...
    return(
        ...
        <Background image = {imageLink}></Background>
            ...
            <Section2>
                ...
                <p>The senate is comprised of 100 elected officers in the US, each of the 50 states in the country have 2 Senators. 
            ...
            <Section3>
                ...
                <p>Green:</p>
                <p>Constitution:</p>
                <p>These are only the major and minor parties listed on most ballots in the US. This list is not exhastive- there are many other smaller parties that have been created when people feel that no other party represents them!</p>
            </Section3>
        </div>
    )
}
