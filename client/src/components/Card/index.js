    ...
    <div>
        <div className="uk-card uk-card-default item-card">
            <div className="uk-card-body info-container">
                <div className="uk-position-relative" tabIndex="-1" uk-slideshow="true">
                    <ul className="uk-slideshow-items">
                        ...
                        <li>
                            <div className="uk-text-center rep-contact">
                                <a className = "rep-url" href = {props.url}>{props.url}</a>
                                <h6 className = "rep-phone">Contact Number:<br></br>{props.phone}</h6>
                                {props.children}
                            </div>
                        </li>
                    </ul>
            ...
            <div className="party-banner" style = {{backgroundColor: `${props.color}`}}>
                <div className = "row">
