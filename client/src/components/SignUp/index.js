  ...
  handleChange(event) {
    ...
    switch (name) {
      ...
      case "password":
        ...
        break;
      case "zipcode":
        errors.zipcode = validZipCodes.test(value)
          ? ""
          : "Zipcode is not valid!";
        break;
      case "location":
        errors.location =
          value.length < 3 ? "Please enter the full name of the state" : "";
        break;
      default:
        break;
    }
      ...
      <div className="uk-container uk-overlay-default">
        ...
        >
          ...
          <p className="paragraph">
            Click <a href="/login">here</a> to login if you already have an
            account.
          </p>
        </form>
      </div>
